...
public class Taylor
{
    ...
    public Taylor(ExpressionType exp, List<(char, double)> center,
        int precision)
    {
        if (!Check(center, exp))
            throw new Exception(
    ...
    {
        ExpressionType sum = new NumberExpression(0);
    ...
    private bool Check(List<(char, double)> variables, ExpressionType exp)
    {
