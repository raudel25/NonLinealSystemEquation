...
public abstract class ExpressionType
{
    ...
    public abstract double Evaluate(List<(char, double)> variables);
    ...
    public static Subtraction operator -(ExpressionType value) =>
        new Subtraction(new NumberExpression(0), value);
    ...
    public static ExpressionType operator ++(ExpressionType value) => value + new NumberExpression(1);
